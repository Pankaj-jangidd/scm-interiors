          ...
          >
            {selectMode && (
              <input
                ...
                className="absolute top-2 left-2 z-20 h-5 w-5 accent-[#8B6B4A]"
              />
            )}
      ...
      <PageTransition>
        <div className="space-y-6">
          ...
          <Card
            ...
            style={{ background: "#F5EFE7", border: "1px solid #E6D8C7" }}
          >
            {viewMode === "overview" ? (
              <>
                  ...
                  {RESIDENTIAL_CATEGORIES.map((cat) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-gradient-to-br from-[#8B6B4A]/0 via-[#8B6B4A]/0 to-[#8B6B4A]/0 group-hover:from-[#8B6B4A]/8 group-hover:via-[#8B6B4A]/4 group-hover:to-[#8B6B4A]/8 transition-all duration-500" />

                        {/* Decorative corner accent */}
                        <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-bl from-[#8B6B4A]/5 to-transparent rounded-bl-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                        ...
                        <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#8B6B4A] to-transparent opacity-0 group-hover:opacity-100 transition-all duration-500 transform scale-x-0 group-hover:scale-x-100" />
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex items-center gap-2 text-sm">
                    <span style={{ color: "#8B6B4A", fontWeight: 600 }}>
                      Residential
                    </span>
                    <span style={{ color: "#C2B5A6" }}>/</span>
                    <span style={{ color: "#42322A", fontWeight: 600 }}>
                      {activeSubcategory}
                    </span>
                  </div>
                </div>
                  ...
                  <div className="flex gap-2">
                    ...
                    {!selectMode && currentSubcategoryImages.length > 0 && (
                      <button
                        ...
                        style={{ borderColor: "#8B6B4A", color: "#8B6B4A" }}
                        disabled={isDeleting}
                      >
                        Select
                      </button>
                    ...
                    {selectMode && (
                      <>
                        ...
                        <button
                          ...
                          className="inline-flex items-center px-3 py-2 rounded-md border transition-all duration-200 hover:bg-white"
                          style={{ borderColor: "#C2B5A6", color: "#4B4B4B" }}
                        >
                          Cancel
                        </button>
                      </>
          ...
          >
            ...
            >
              <DialogHeader>
                <DialogTitle style={{ color: "#42322A" }}>
